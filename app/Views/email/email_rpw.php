  ...
  <div class="container">
    <div class="row">
      <div class="col-md-6 offset-md-3">
        ...
        <p class="text-center">Hello, <?= $get['nama'] ?></p>
        ...
        <p class="text-center">
          <a href="<?= base_url('reset-password/v1/'.$get['email'].'/'.$get['token']) ?>" class="btn btn-primary">Reset Password</a>
        </p>
        <hr>
        ...
        <p class="text-center"><a href="<?= base_url('reset-password/v1/'.$get['email'].'/'.$get['token'])  ?>"><?= base_url('reset-password/v1/'.$get['email'].'/'.$get['token'])  ?></a></p>
